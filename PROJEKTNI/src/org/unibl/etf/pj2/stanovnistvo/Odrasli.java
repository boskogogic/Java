...
/**	Klasa Odrasli za specifikaciju dijela stanovnistva izmedju 18 i 65 godina, sa odredjenim atributima i metodama.
 */
...
public class Odrasli extends Stanovnik {
	...
	public Odrasli(String ID, String ime, String prezime, String godinaRodjenja, String pol, String kucaID, Grad matrica, int pozicijaVrsta, int pozicijaKolona ) {
	...
	public String toString() {
		return "Grupa stanovnistva : Odrasli \n " + super.toString();
	}
	...
	/**	Metoda za racunanje procenta koliko se odrasla osoba moze kretati -> Provjereno u odvojenom programu */
	public int izracunajBrojPolja(int vrsta) {
		double brojPoljaMatrice = vrsta;
		double procenat = 25;
		double racunanje = brojPoljaMatrice / 100;
		int brojPolja = (int) Math.round(racunanje * procenat);
		return brojPolja;
	}
	...
	public void run() {
		...
		System.out.println("Odrasli " + super.getID() + " je na poziciji " + pozicijaVrsta + " " + pozicijaKolona + " i pocinje sa kretanjem!" ); //NAPOMENA -> Poziv metode super.metoda() !!
		int brojPredjenihPolja = 0;
		
		/**	Racunanje procenta koliko se moze kretati odredjeni stanovnik - PROVJERENO */
		int brojPolja = this.izracunajBrojPolja(matrica.getBrojVrsta());
		...
		if(smjerKretanja == 1) {
			while(brojPredjenihPolja < brojPolja) {
				...
				if((this.provjeriKonPunkt(vrsta, kolona))) {
					System.out.println("Odrasli " + super.getID() + " je naisao na Kontrolni punkt!");
				...
				if((this.provjeriBlizinuStanovnika(vrsta, kolona))){				
					...
					//if((("K").equals(matrica.pristupiVrstiKoloni(vrsta+1, kolona))) || (("A").equals(matrica.pristupiVrstiKoloni(vrsta+1, kolona)))) {
						...
						if( (!(("K").equals(matrica.pristupiVrstiKoloni(vrsta, kolona-1))) && !(("A").equals(matrica.pristupiVrstiKoloni(vrsta, kolona-1)))) && !(this.provjeriLijevo(vrsta, kolona-1)) ) {
							System.out.println("Odrasli" + super.getID() + " se nalazi na polju: " + vrsta + " " + (kolona-1) + " krece se lijevo");
						...
						/*	U slucaju da je nemoguce ni u jednom smjeru ici */
							...
							System.out.println("Odrasli " + super.getID() + " ne moze da nastavi kretanje!");
				...
				if( (("1").equals(matrica.pristupiVrstiKoloni(vrsta+1, kolona))) && !(this.provjeriDole(vrsta, kolona)) ) {
					System.out.println("Odrasli " + super.getID() + " se nalazi na polju: " + vrsta+1 + " " + kolona + " krece se dole! ");
					vrsta++;
					matrica.setMatricaGrada(trenutnaVrsta, trenutnaKolona, "1"); //postavi proslo mjesto na slobodno!
					trenutnaVrsta = vrsta;
					trenutnaKolona = kolona;
			...
			while(brojPredjenihPolja < brojPolja) {
				...
				if((this.provjeriBlizinuStanovnika(vrsta, kolona))){				
						...
						/**	Ako je nemoguce dole onda probaj gore */
							...
							System.out.println("Odrasli " + super.getID() + " se nalazi na polju: " + vrsta + " " + kolona+1 + " krece se gore");
							matrica.setMatricaGrada(trenutnaVrsta, trenutnaKolona, "1"); //postavi proslo mjesto na slobodno!
							vrsta--;
							brojPredjenihPolja++;
							trenutnaVrsta = vrsta;
				...
				/**	Provjera da li je na sledecem polju i datom smjeru kuca ili ambulanta  */
					...
					if( (!(("K").equals(matrica.pristupiVrstiKoloni(vrsta+1, kolona))) && !(("A").equals(matrica.pristupiVrstiKoloni(vrsta+1, kolona)))) && !(this.provjeriDole(vrsta, kolona)) ) {
						System.out.println("Odrasli" + super.getID() + " se nalazi na polju: " + vrsta+1 + " " + kolona + " krece se lijevo");
						matrica.setMatricaGrada(trenutnaVrsta, trenutnaKolona, "1"); // postavi proslo mjesto na slobodno!
						vrsta++;
						brojPredjenihPolja++;
						trenutnaVrsta = vrsta;
					...
					/**	Ako je nemoguce dole onda probaj gore */
						...
						System.out.println("Odrasli " + super.getID() + " se nalazi na polju: " + (vrsta-1) + " " + kolona + " krece se desno");
						matrica.setMatricaGrada(trenutnaVrsta, trenutnaKolona, "1"); //postavi proslo mjesto na slobodno!
						vrsta--;
						brojPredjenihPolja++;
						trenutnaVrsta = vrsta;
				...
				if(("2").equals(matrica.pristupiVrstiKoloni(vrsta, kolona-1)) || ("2").equals(matrica.pristupiVrstiKoloni(vrsta+1, kolona-1)) || ("2").equals(matrica.pristupiVrstiKoloni(vrsta-1, kolona-1))) {
						...
						/**	Ako ne moze vise lijevo preusmjeri dole */
							...
							System.out.println("Odrasli " + super.getID() + " se nalazi na polju: " + vrsta + " " + (kolona-1) + " krece se dole");
						...
						/**	Ako ne moze vise ni dole ni lijevo - moze gore */
							...
							System.out.println("Odrasli " + super.getID() + " se nalazi na polju: " + vrsta+1 + " " + kolona + " krece se gore");
							matrica.setMatricaGrada(trenutnaVrsta, trenutnaKolona, "2");//da se postavi proslo polje na slobodno
							vrsta--;
							trenutnaVrsta = vrsta;
							trenutnaKolona = kolona;
